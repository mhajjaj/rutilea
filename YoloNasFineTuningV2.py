...
class config:
    #trainer params
    CHECKPOINT_DIR = 'checkpoint/YoloNasFineTuningV2' #specify the path you want to save checkpoints to
    EXPERIMENT_NAME = 'choose-an-experiment-name' #specify the experiment name

    #dataset params
    DATA_DIR = 'U.S.-Coins-Dataset---A.Tatham-5' #parent directory to where data lives
